...
func (x *OrderResponse) GetPaid() bool {
	if x != nil {
		return x.Paid
	}
	return false
...
const file_proto_order_proto_rawDesc = "" +
	...
	"\fOrderService\x128\n" +
	"\vCreateOrder\x12\x13.order.OrderRequest\x1a\x14.order.OrderResponseB'Z%grpc-k8s-playground/order-service/genb\x06proto3"
